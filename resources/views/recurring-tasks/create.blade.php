...
<x-app-layout title="Create Recurring Task">
    <x-slot name="header">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form
                        method="POST"
                        action="{{ route('recurring-tasks.store') }}"
                        class="space-y-6"
                        x-data="{
                    ...
                    >
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="3" class="{{ $selectClass }}">{{ old('description') }}</textarea>
