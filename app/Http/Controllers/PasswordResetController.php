...
class PasswordResetController extends Controller
{
    ...
    public function sendPasswordResetEmail(SendPasswordResetEmailRequest $request)
    {
        ...
        return back()->with('status', 'If an account with email exists, we will send a password reset link');
    }
    ...
    public function resetPassword(ResetPasswordRequest $request)
    {
       ...
       $status = Password::reset($requestData, function (User $user, $newPassword) {
